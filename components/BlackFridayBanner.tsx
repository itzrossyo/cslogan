...
async function BlackFridayBanner() {
    ...
    return (
        <div className="bg-gradient-to-r from-red-600 to-black text-white px-6 py-10 mx-4 mt-2 rounded-lg shadow-lg">
            <div className="contaniner mx-auto flex items-center justify-between">
                <div className="flex-1">
                    <h2 className="text-3xl sm:text-5xl font-extrabold text-left md-4">
                        {sale.title}
                    </h2>
                    <p className="text-left text-xl sm:text3xl font-semibold mb-6">
                        {sale.description}
                    </p>
                    <div className="flex">
